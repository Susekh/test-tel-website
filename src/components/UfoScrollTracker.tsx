...
const UFO_ROUTE: UfoWaypoint[] = [
  ...
  { progress: 0.2, xPercent: 500 },  // move right
  { progress: 0.4, xPercent: 300 },   // left
  { progress: 0.6, xPercent: 95 },  // right 
  { progress: 0.8, xPercent: 0 },   // left 
  { progress: 1.0, xPercent: 130 },  // finish right
];
