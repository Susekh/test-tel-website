...
function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent){
    ...
    if (validate()) {
      ...
      try{
          setLoading(true);
          const response = await fetch('https://formsubmit.co/ajax/courses@telusko.com',{
            method : 'POST',
            headers: { 
  ...
  return (
    <div className="flex flex-col self-end"> 
           ...
           >
              ...
              <button 
              className="cursor-pointer duration-300 hover:scale-102 hover:bg-black w-fit items-center text-sm justify-center gap-2 text-white  mt-4 flex  font-Grostek font-[600] fon  py-3.5 px-4.5 bg-btn shadow-[4px_4px_0_0_#000]">
